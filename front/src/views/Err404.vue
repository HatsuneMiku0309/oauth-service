<template>
  <div id="err404" class="body absolute top-0 w-screen h-screen">
    ...
    <section class="error">
      ...
      <div class="error__content">
        <div class="error__message message">
          <h1 class="message__title">404 Page Not Found</h1>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      const elem = document.getElementById('err404');
      let i = parseInt('28', 16);
      let gap = 1;
      interId = setInterval(() => {
        if (i >= parseInt('ff', 16)) {
          gap = -1;
        } else if (i <= parseInt('28', 16)) {
          gap = 1;
        }
        elem!.style.background = rgbToHex(parseInt('18', 16), parseInt('18', 16), i);
        i += gap;
      }, 100);
    });
  },
...
.top-header:before {
    background-image: url('@/../public/images/header-footer-gradient-bg.png');
}
.top-header:before {
    content: '';
    display: block;
...
.light {
    width: 200px;
    height: 400px;
    border-bottom: 400px solid rgb(44,255,255,24%);
    ...
    z-index: 1;
    filter: blur(200px);
    box-shadow: 0px 100px 1000px 120px rgb(44,255,255,50%);
